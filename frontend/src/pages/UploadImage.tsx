            ...
            <Card className="bg-z-light-green shadow-lg border border-gray-200 rounded-xl overflow-hidden">
              ...
              <CardContent className="p-4">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  {/* Project Selection */}
                  <div className="flex items-center space-x-4">
                    <Label htmlFor="projectId" className="text-sm font-semibold text-gray-900 flex items-center space-x-2 min-w-fit">
                    ...
                    <div className="flex-1">
                      <Select onValueChange={(value) => setValue('projectId', value)}>
                        <SelectTrigger className="h-10 border-2 rounded-xl transition-all duration-300 focus:border-teal-500 focus:ring-2 focus:ring-teal-500/10 bg-white shadow-sm hover:shadow-md">
                          <SelectValue placeholder="Choose a project to verify against" />
                        </SelectTrigger>
                        <SelectContent className="rounded-xl border-0 shadow-xl">
                          {projects.map((project) => (
                            <SelectItem key={project.id} value={project.id} className="rounded-lg py-2">
                      ...
                      {uploadedImages.length === 0 ? (
                        <div className="space-y-2">
                          ...
                          <div>
                            ...
                            <div className="inline-flex items-center px-3 py-1 bg-teal-100 text-teal-700 rounded-lg text-xs font-medium">
                          ...
                          <div>
                            ...
                            <div className="flex justify-center space-x-2 mb-2">
                              ...
                              <Button
                                ...
                                className="border-teal-200 text-teal-600 hover:bg-teal-50 h-8 px-3 text-xs"
                              >
                  ...
                  <div className="pt-2 flex justify-center">
                    <Button
                      ...
                      className="h-10 px-6 bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-200 rounded-xl disabled:opacity-50"
                    >
                      {isVerifying ? (
                        <>
