...
import com.ipter.security.JwtAuthenticationEntryPoint;
import com.ipter.security.JwtAuthenticationFilter;
...
/**
 * Security configuration for the IPTER application
 */
@Configuration
@EnableWebSecurity
